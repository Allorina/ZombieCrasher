...
public class GameplayController : MonoBehaviour
{
    ...
    public float min_ObtacleDelay = 10f, max_ObtacleDelay = 40f;
    ...
    {
        float timer = Random.Range(min_ObtacleDelay, max_ObtacleDelay)/ playerController.speed.z;
    ...
    void CreateObstacles(float zPos)
    {
        ...
        if (0 <= r && r < 7)
        {
            ...
            AddZombies(new Vector3(lanes[zombieLane].position.x,0.15f,zPos));
